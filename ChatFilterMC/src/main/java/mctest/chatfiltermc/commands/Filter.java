            ...
            case "notes":
                ...
                switch (args[1].toLowerCase()) {
                    ...
                    case "add":
                        ...
                        sender.sendMessage(ChatColor.GREEN + "Note added for " + args[2] + ".");
                        break;
                    case "remove":
                        if (args.length == 3) {
                        ...
                        if (Objects.equals(args[3], "all")) {
                            ...
                            sender.sendMessage(ChatColor.GREEN + "Removed all notes for " + args[2] + ".");
                            ...
                            this.historyConfig.save();
                            plugin.setHistoryConfig(this.historyConfig);
                            sender.sendMessage(ChatColor.GREEN + "Removed the chat history from notes of " + args[2] + ".");
                        } else {
                            ...
                            try {
                                ...
                                this.historyConfig.save();
                                plugin.setHistoryConfig(this.historyConfig);
                                sender.sendMessage(ChatColor.GREEN + "Removed note " + args[3] + " for " + args[2] + ".");
                            } catch (Exception e) {
                            ...
                            switch (args[3].toLowerCase()) {
                                case "clear":
                                    if (args.length == 4) {
                                        ...
                                        sender.sendMessage(ChatColor.GREEN + "Removed all of the strikes for " + args[2] + ".");
                                        ...
                                        sender.sendMessage(ChatColor.GREEN + "Strikes removed for " + args[2] + ".");
                                    } else {
            ...
            try {
                switch (args[1].toLowerCase()) {
                        ...
                        switch (args[2].toLowerCase()) {
                            ...
                            case "remove":
                                try {
                                    ...
                                    plugin.setFilterConfig(this.filterConfig);
                                    sender.sendMessage(ChatColor.GREEN + "Removed filter command for " + args[0] + ".");
                                } catch (Exception e) {
                    ...
                    case "replace":
                        switch (args[2].toLowerCase()) {
                            ...
                            case "add":
                                ...
                                plugin.setFilterConfig(this.filterConfig);
                                sender.sendMessage(ChatColor.GREEN + "Added replacement message for " + args[0] + ".");
                                break;
                            case "remove":
                                try {
                                    ...
                                    plugin.setFilterConfig(this.filterConfig);
                                    sender.sendMessage(ChatColor.GREEN + "Removed replacement message for " + args[0] + ".");
                                } catch (Exception e) {
                    ...
                    case "history":
                        switch (args[2]) {
                            case "on": case "off":
                                ...
                                this.filterConfig.getConfig().set("groups." + args[0] + ".history", state);
                                plugin.setFilterConfig(filterConfig);
                    ...
                    case "add":
                        ...
                        sender.sendMessage(ChatColor.GREEN + "Added " + args[2] + " to " + args[0].toLowerCase() + " filter list.");
                        break;
                    case "remove":
                        if (args.length != 3) {
                        ...
                        plugin.setWordList(this.wordListConfig);
                        plugin.getRegexBuilder().buildRegex(args[0].toLowerCase());
                        sender.sendMessage(ChatColor.GREEN + "Removed " + args[2] + " to " + args[0].toLowerCase() + " filter list.");
                        break;
                    default:
